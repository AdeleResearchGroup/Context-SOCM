...
do
  CLASSPATH=${CLASSPATH}:${i}
    ...
    "$JAVA" -cp ${CLASSPATH} ${JVM_ARGS} -Xdebug -Xrunjdwp:transport=dt_socket,address=8000,server=y,suspend=y -Dchameleon.home=$dir org.ow2.chameleon.core.Main --interactive "$@"
